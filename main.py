...
with SQLite() as db:
    ...
    db.create_table("files", {"id": "TEXT PRIMARY KEY", "filename": "TEXT", "hash": "TEXT UNIQUE NOT NULL", "size": "INTEGER NOT NULL", "mimetype": "TEXT", "file_type": "TEXT NOT NULL CHECK (file_type IN ('attachment', 'pfp'))"})
...
if frontend:
    ...
    def serve_static(path):
        ...
        safe_path=os.path.relpath(safe_path)
